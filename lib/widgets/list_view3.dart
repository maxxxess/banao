...
class CustomList3ViewBuilder extends StatefulWidget {
  final List<CustomList3Item> items;

  CustomList3ViewBuilder({required this.items});

  @override
  State<CustomList3ViewBuilder> createState() => _CustomList3ViewBuilderState();
}

class _CustomList3ViewBuilderState extends State<CustomList3ViewBuilder> {
  @override
